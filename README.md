...
[![crates.io](https://img.shields.io/crates/v/rustoku-lib)](https://crates.io/crates/rustoku-lib)
...
- [**Python Guide**](https://github.com/huangsam/rustoku/blob/main/docs/python.md) - Using the engine from Python.
...
rustoku-cli generate --difficulty expert

# Solve puzzles
rustoku-cli solve any 530070000600195000098000060800060003400803001700020006060000280000419005000080079
rustoku-cli solve any --human --verbose 801027003000600080005040010000070809900000050600900200000230160570160000000000000
rustoku-cli solve all 295743001431865900876192543387459216612387495549216738763500000000000000000000000
rustoku-cli solve all --until 5 000000500080760092001005470056309000009001004320500010000200700700000000000000000
