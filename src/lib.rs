...
//!
//! This module provides a `SudokuSolver` struct that can solve 9x9 Sudoku puzzles using a
//! backtracking algorithm. The solver uses bitmasks to efficiently track constraints for rows,
//! columns, and 3x3 boxes, enabling fast validation and candidate computation during the solving process.
//!
//! # Features
...
pub use solver::{SudokuError, SudokuSolver, print_sudoku_board};
